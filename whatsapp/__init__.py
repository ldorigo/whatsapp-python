...
class WhatsApp(object):
    ...
    from whatsapp.ext._property import authorized
    from whatsapp.ext._send_others import send_custom_json, send_contacts
    from whatsapp.ext._message import send_template
    from whatsapp.ext._send_media import send_image, send_video, send_audio, send_location, send_sticker, send_document
    from whatsapp.ext._media import upload_media, query_media_url, download_media, delete_media
    from whatsapp.ext._buttons import send_button, create_button, send_reply_button
    from whatsapp.ext._static import is_message, get_mobile, get_author, get_name, get_message, get_message_id, get_message_type, get_message_timestamp, get_audio, get_delivery, get_document, get_image, get_interactive_response, get_location, get_video, changed_field
...
class Message(object):
    ...
    from whatsapp.ext._message import send, reply, mark_as_read
